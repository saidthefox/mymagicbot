...
function persist(m) { fs.mkdirSync(DATA_DIR, { recursive: true }); fs.writeFileSync(FILE, JSON.stringify(m, null, 2)); }

// ctx examples:
//  { type:'join',    tournamentId, userId }
//  { type:'pairing', tournamentId, round, table, userId }   // userId = whose private channel
//  { type:'confirm', tournamentId, round, table, userId }   // userId = the loser confirming
